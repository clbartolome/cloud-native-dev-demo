...
:loudspeaker: Introduction to Development Environment Demo content - [deck of slides](TODO.com) [x to x] TODO :loudspeaker: 
...
```sh
kustomize build application-cicd/deploy/overlays/stage
```
