...
:loudspeaker: Introduction to Development Environment Demo content - [slides](TODO.com) [x to x] TODO :loudspeaker: 
...
:loudspeaker: Review Quarkus - slides [x to x] TODO :loudspeaker: 
...
:loudspeaker: Review CRW - slides [x to x] TODO :loudspeaker: 
...
Add a link into README.md to start a workspace (update @CODEREADY_URL and @GITREPO values): 
...
:loudspeaker: Review health checks - slides [x to x] TODO :loudspeaker: 
...
:loudspeaker: While build is running review application resources - slides [x to x] TODO :loudspeaker: 
