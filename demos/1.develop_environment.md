...
**Introduction to Development Environment Demo content - slides [x to x] TODO**
...
**Review Quarkus - slides [x to x] TODO**
...
**Review health checks - slides [x to x] TODO**
...
** While build is running review application resources - slides [x to x] TODO**
